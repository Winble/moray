 ...
 * Create on 2022/7/20
 */
public class FooStateMachineFactory extends AbstractStateMachineFactory<Integer, FooState, FooEvent, BaseResult> {
    ...
    public static void main(String[] args) {
        try {
            ...
            fooStateMachineFactory.load(new AbstractTransition<Integer, FooState, FooEvent, SimpleStateMachine<Integer, FooState, FooEvent>>(FooState.b, FooState.c, FooEvent.b_to_c) {
                @Override
